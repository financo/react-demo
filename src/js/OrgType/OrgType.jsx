...
import OrgTypeTable from './Table';
...
class OrgType extends Common{
    constructor(props) {
        ...
        this.state = {
            ...
            status: "list",
            currentData: {},
            requestPath: `http://127.0.0.1:8080/security/api/orgType/`,
        };
                ...
                <div className="app">
                    <div className="rightWrap">
                        <div className="box-title">
                            <h4 style={{'fontWeight': 'bold'}}>组织机构类型列表</h4>
                        </div>
                        <div className="right-box">
                            ...
                            <Divider/>
                            <OrgTypeTable tableData={this.state.tableData.content}
...
ReactDOM.render(<OrgType/>, document.getElementById('root'));